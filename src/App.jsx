      ...
      <BlurFade delay={0.25} inView>
        ...
        <section className="mt-12 max-w-3xl mx-auto">
          ...
          <p className=" text-neutral-900">
            Experienced Web Developer with over 7 years of expertise in building
            dynamic web applications using PHP, React and Laravel. Skilled in
            &nbsp;
            <span className="underline text-black">
              full-stack development, REST APIs, Microservices, MySQL, and
              integrating third-party services
            </span>
            . Successful at maintaining customer satisfaction through effective
            customer support.
          </p>
        </section>
        ...
        <section className="mt-12 max-w-3xl mx-auto">
          ...
          <p className=" text-neutral-900">
            Hands-on experience in full-stack development, REST API design, and
            building scalable software solutions across diverse domains,
        ...
        <section className="mt-12 mb-36 max-w-3xl mx-auto">
          ...
          <p className=" text-neutral-900">
            I'm always excited to connect! Whether you have a project in mind, a
